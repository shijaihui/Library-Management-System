...
<body style="background:/libSys/public/syspkg/images/background">
	...
	<div class="home" id="home">
		<div class="block">
			...
			<div style="text-align: center">
				<a v-on:click="forgetpas">Forget your password?</a>
			</div>
			<div class="line">
		...
		var app = new Vue({
			...
			methods: {
				submit: function (event) {
					...
					$.ajax({
						...
						success: function (data) {
							...
							if (data.code == 'fail') {
								layer.msg("Invalid account or password")
							}
						}
					})
				...
				forgetpas: function (index) {
					 ...
					 */
					$.ajax({
						url: "<?php echo U('Index/forgetPassword');?>",
						type: "post",
						contentType: "application/x-www-form-urlencoded;charset=utf-8",
						data: {
							account: that.account,
						...
						dataType: "json",
						success: function (data) {
							//layer.msg("Please wait a minite and see your password on your cell phone!")
							layer.msg(data.msg)
						}
					})
