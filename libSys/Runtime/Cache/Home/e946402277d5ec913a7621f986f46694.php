        ...
        layer.confirm('编辑项目后，已通过的项目将重新提交审核', {
            btn: ['确定','取消'], //按钮
               ...
               layer.open({
                   ...
                   shade: 0.8,
                   area: ['700px', '480px'],
                   content: "generalTeacherResearchFundEdit.html" ,//iframe的url
                    success: function(layero,index)
                    {
                      var input_name = layer.getChildFrame('#fundName',index);
                      input_name.val(name);
                      var input_stm = layer.getChildFrame('#fundStm',index);
                      input_stm.val(stm);
                      var input_fund = layer.getChildFrame('#fundFund',index);
                      input_fund.val(fund);
                      var input_paid = layer.getChildFrame('#fundPaid',index);
                      input_paid.val(paid);
                      var input_remain = layer.getChildFrame('#fundRemain',index);
                      ...
                      input_id.click(function(){
                         ...
                         form1.ajaxSubmit({
                          url : "<?php echo U('Home/updateResearchFund');?>",
                          data: { data : id },
                          type : "post",
    ...
    $(document).ready(function(){
        $("button.add").click(function(){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '480px'],
                content: 'generalTeacherResearchFundAdd.html', //iframe的url
                success: function(layero,index)
                {
                  var button = layer.getChildFrame('input#btn',index);
                  button.click(function(){
                    var form = layer.getChildFrame('form#addresearchfund',index);
                   
                      form.ajaxSubmit({
                          url : "<?php echo U('Home/insertResearchFund');?>",
                          type : "post",
                          enctype : "multipart/form-data",
                          dataType:'json',
                          success: function(data){
        ...
        $("button.delete").click(function(){
            ...
            layer.confirm('可点击“编辑”以再次编辑并重新提交审核,删除后将不可恢复，确定删除该项目吗？',{
                    ...
                    //删除确定的ajax代码应该放在这里
                     $.post("<?php echo U('Home/deleteResearchFund');?>",{
                        data  : id
                      },
...
<!-- 主体部分 -->
    <div class="main">
        ...
        <div class="teacher">
            <h name="xi"><?php echo ($researchFund_WAIT); ?>项待审核 <?php echo ($researchFund_YES); ?>项已通过 
            <?php echo ($researchFund_NO); ?>项未通过</h>    
        </div>
        <div class="hr0">
            <hr>
        </div>
        ...
        <table>
            ...
            <tbody>
                <?php if(is_array($researchFundWAIT)): $i = 0; $__LIST__ = $researchFundWAIT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT">
        ...
        <table>
            ...
            <tbody>
                <?php if(is_array($researchFundYES)): $i = 0; $__LIST__ = $researchFundYES;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-YES">
        ...
        <table>
            ...
            <tbody>
                 <?php if(is_array($researchFundNO)): $i = 0; $__LIST__ = $researchFundNO;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-NO">
