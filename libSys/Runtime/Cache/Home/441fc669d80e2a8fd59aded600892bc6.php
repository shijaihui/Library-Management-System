...
{
    $("#drp2").click();
    $("#m23").css("background-color","#363536");
...
<script>
    ...
    /*编辑项目*/
       ...
       $("button.update").click(function(){
            ...
            var signature = $("td#"+id+"-signature").text();
        ...
        layer.confirm('编辑项目后，已通过的项目将重新提交审核', {
            btn: ['确定','取消'], //按钮
               ...
               layer.open({
                   ...
                   shade: 0.8,
                   area: ['700px', '480px'],
                   content: "generalTeacherTeachTbpEdit.html" ,//iframe的url
                    success: function(layero,index)
                    {
                      ...
                      input_pub.val(pub);
                      var input_signature = layer.getChildFrame('#signature',index);
                      input_signature.val(signature);
                      ...
                      input_id.click(function(){
                         ...
                         form1.ajaxSubmit({
                          url : "<?php echo U('Home/updateTeachTbp');?>",
                          data: { data : id },
                          type : "post",
    ...
    $(document).ready(function(){
        $("button.add").click(function(){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '480px'],
                content: 'generalTeacherTeachTbpAdd.html', //iframe的url
                success: function(layero,index)
                {
                  var button = layer.getChildFrame('#btn',index);
                  button.click(function(){
                    var form = layer.getChildFrame('form#addteachtbp',index);
                   
                      form.ajaxSubmit({
                          url : "<?php echo U('Home/insertTeachTbp');?>",
                          type : "post",
                          enctype : "multipart/form-data",
                          dataType:'json',
                          success: function(data){
        ...
        $("button.delete").click(function(){
            ...
            layer.confirm('可点击“编辑”以再次编辑并重新提交审核,删除后将不可恢复，确定删除该项目吗？',{
                    ...
                    //删除确定的ajax代码应该放在这里
                     $.post("<?php echo U('Home/deleteTeachTbp');?>",{
                        data  : id
                      },
...
<!-- 主体部分 -->
    <div class="main">
        <div class="home">
            <h style="font-weight: bold;">教材出版</h>
        </div>
        <div class="teacher">
            <h name="xi"><?php echo ($teachTbp_WAIT); ?>项待审核   <?php echo ($teachTbp_YES); ?>项已通过   <?php echo ($teachTbp_NO); ?>项未通过</h>    
        </div>
        <div class="hr0">
            <hr>
        </div>
        ...
        <table>
            ...
            <tbody>
                  <?php if(is_array($teachTbpWAIT)): $i = 0; $__LIST__ = $teachTbpWAIT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT">
        ...
        <table>
            ...
            <tbody>
                  <?php if(is_array($teachTbpYES)): $i = 0; $__LIST__ = $teachTbpYES;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-YES">
        ...
        <table>
            ...
            <tbody>
                  <?php if(is_array($teachTbpNO)): $i = 0; $__LIST__ = $teachTbpNO;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-NO">
