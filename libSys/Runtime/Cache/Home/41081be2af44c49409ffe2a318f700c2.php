...
{
    $("#drp2").click();
    $("#m21").css("background-color","#363536");
...
<script>
    ...
    /*编辑项目*/
       ...
       $("button.update").click(function(){
            ...
            var dep = $("td#"+id+"-dep").text();
            var tm = $("td#"+id+"-tm").text();
            var lv = $("td#"+id+"-lv").text();
        ...
        layer.confirm('编辑项目后，已通过的项目将重新提交审核', {
            btn: ['确定','取消'], //按钮
               ...
               layer.open({
                   ...
                   shade: 0.8,
                   area: ['700px', '480px'],
                   content: "<?php echo U('Home/generalTeacherTeachAchEdit');?>" ,//iframe的url
                    success: function(layero,index)
                    {
                      var input_name = layer.getChildFrame('#name',index);
                      input_name.val(name);
                      var input_dep = layer.getChildFrame('#dep',index);
                      input_dep.val(dep);
                      var input_tm = layer.getChildFrame('#tm',index);
                      input_tm.val(tm);
                      var input_lv = layer.getChildFrame('#lv',index);
                      input_lv.val(lv);
                      ...
                      input_id.click(function(){
                         ...
                         form1.ajaxSubmit({
                          url : "<?php echo U('Home/updateTeachAch');?>",
                          data: { data : id },
                          type : "post",
    ...
    $(document).ready(function(){
        $("button.add").click(function(){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '480px'],
                content: "<?php echo U('Home/generalTeacherTeachAchAdd');?>", //iframe的url
                success: function(layero,index)
                {
                  var button = layer.getChildFrame('#btn',index);
                  button.click(function(){
                    var form = layer.getChildFrame('form#addteachach',index);
                   
                      form.ajaxSubmit({
                          url : "<?php echo U('Home/insertTeachAch');?>",
                          type : "post",
                          enctype : "multipart/form-data",
                          dataType:'json',
                          success: function(data){
      ...
      $(document).ready(function(){
        ...
        $("button.delete").click(function(){
            ...
            layer.confirm('可点击“编辑”以再次编辑并重新提交审核,删除后将不可恢复，确定删除该项目吗？',{
                    ...
                    //删除确定的ajax代码应该放在这里
                     $.post("<?php echo U('Home/deleteTeachAch');?>",{
                        data  : id
                      },
...
<!-- 主体部分 -->
    <div class="main">
        <div class="home">
            <h style="font-weight: bold;">教学成果奖</h>
        </div>
        <div class="teacher" style="margin-left: 20px;">
            <h name="xi"><?php echo ($teachAch_WAIT); ?>项待审核  <?php echo ($teachAch_YES); ?>项已通过  <?php echo ($teachAch_NO); ?>项未通过</h>    
        </div>
        <div class="hr0">
            <hr>
        </div>
        <script type="text/javascript">
       $(document).ready(function(){
       $("button#bStay").click(function(){
          $(this).tab('show');
          $.post("<?php echo U('Home/getTeachAchWAIT');?>",
          function(data){
        ...
        <table>
            ...
            <tbody>
            <?php if(is_array($teachAchWAIT)): $i = 0; $__LIST__ = $teachAchWAIT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT">
        ...
        <table>
            ...
            <tbody>
              <?php if(is_array($teachAchYES)): $i = 0; $__LIST__ = $teachAchYES;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-YES">
        ...
        <table>
            ...
            <tbody>
            <?php if(is_array($teachAchNO)): $i = 0; $__LIST__ = $teachAchNO;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-NO">
