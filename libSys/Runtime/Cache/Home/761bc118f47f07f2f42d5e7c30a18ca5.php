...
<div class="home">
        ...
        <table>
            ...
            <tbody>
    <?php if(is_array($otherWel)): $i = 0; $__LIST__ = $otherWel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-other_wel">
        ...
        <?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-other_wel-download" ><span class="glyphicon glyphicon-save" ></span></a></td>
        <td><button class="pass" id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-other_wel">通过</button><button class="rj" id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-other_wel">拒绝</button></td>
