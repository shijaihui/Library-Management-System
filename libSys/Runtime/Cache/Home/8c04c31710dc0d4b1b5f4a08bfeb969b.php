...
<head>
 ...
 <!--引入jquery-->
    ...
    <link href="/mksys/Public/syspkg/css/jiaoxue.css" rel="stylesheet" >
    ...
    $(document).ready(function(){
        $("a#ToNext").click(function(){
            ...
            $.post("<?php echo U('Home/generalTeacherPassValue');?>",{
                ...
                if(data == 'success'){
                    window.location.href = "<?php echo U('Home/generalTeacherUserFindNext');?>";
...
<div class="home">
            <h style="font-weight: bold;">按教师查看</h>
        </div>

        <div class="hr0">
            <hr>
        </div>       
             <form action="<?php echo U('Home/generalTeacherUserFind');?>" method="POST">   
        ...
        <table>
            ...
            <tbody>
                 <?php if(is_array($UserFind)): $i = 0; $__LIST__ = $UserFind;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['id']); ?>-all">
                    ...
                    <td id="<?php echo ($ta['id']); ?>-all">共计<strong style="color:red"><?php echo ($ta['allNum']); ?></strong>项</td>8
