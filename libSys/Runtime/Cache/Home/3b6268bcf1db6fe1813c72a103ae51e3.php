...
<div class="home">
        ...
        <div style="position: absolute;left: 310px;top: 60px;color: #AAAAAA;">
        ...
        <table>
            ...
            <tbody>
    <?php if(is_array($researchMpb)): $i = 0; $__LIST__ = $researchMpb;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-research_mpb">
        ...
        <?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-research_mpb-download" ><span class="glyphicon glyphicon-save" ></span></a></td>
        <td><button class="pass" id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-research_mpb">通过</button><button class="rj" id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-research_mpb">拒绝</button></td>
