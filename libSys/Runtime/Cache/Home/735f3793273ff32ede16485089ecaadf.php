    ...
    layer.config({
      ...
      /*编辑项目*/
       ...
       $("button.update").click(function(){
            ...
            var source = $("td#"+id+"-source").text();
            var stm = $("td#"+id+"-stm").text();
            var deadline = $("td#"+id+"-deadline").text();
        ...
        layer.confirm('编辑项目后，已通过的项目将重新提交审核', {
            btn: ['确定','取消'], //按钮
               ...
               layer.open({
                   ...
                   shade: 0.8,
                   area: ['700px', '480px'],
                   content: "generalTeacherResearchProEdit.html" ,//iframe的url
                    success: function(layero,index)
                    {
                      var input_name = layer.getChildFrame('#name',index);
                      input_name.val(name);
                      var input_source = layer.getChildFrame('#source',index);
                      input_source.val(source);
                      var input_stm = layer.getChildFrame('#stm',index);
                      input_stm.val(stm);
                      var input_deadline = layer.getChildFrame('#deadline',index);
                      input_deadline.val(deadline);
                      ...
                      input_id.click(function(){
                         ...
                         form1.ajaxSubmit({
                          url : "<?php echo U('Home/updateResearchPro');?>",
                          data: { data : id },
                          type : "post",
    ...
    $(document).ready(function(){
        $("button.add").click(function(){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '480px'],
                content: 'generalTeacherResearchProAdd.html', //iframe的url
                success: function(layero,index)
                {
                  var button = layer.getChildFrame('#btn',index);
                  button.click(function(){
                    var form = layer.getChildFrame('form#addresearchpro',index);
                   
                      form.ajaxSubmit({
                          url : "<?php echo U('Home/insertResearchPro');?>",
                          type : "post",
                          enctype : "multipart/form-data",
                          dataType:'json',
                          success: function(data){
      ...
      $(document).ready(function(){
        ...
        $("button.delete").click(function(){
            ...
            layer.confirm('可点击“编辑”以再次编辑并重新提交审核,删除后将不可恢复，确定删除该项目吗？',{
                    ...
                    //删除确定的ajax代码应该放在这里
                     $.post("<?php echo U('Home/deleteResearchPro');?>",{
                        data  : id
                      },
...
<!-- 主体部分 -->
    <div class="main">
        <div class="home" style="width: 150px;">
            <h style="font-weight: bold;">主持科研项目</h>
        </div>
        <div class="teacher" style="margin-left: 70px;">
            <h name="xi"><?php echo ($researchPro_WAIT); ?>项待审核 <?php echo ($researchPro_YES); ?>项已通过 
            <?php echo ($researchPro_NO); ?>项未通过</h>    
        </div>
        <div class="hr0">
            <hr>
        </div>
        ...
        <table>
            ...
            <tbody>
                  <?php if(is_array($researchProWAIT)): $i = 0; $__LIST__ = $researchProWAIT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT">
        ...
        <table>
            ...
            <tbody>
             ...
             <?php if(is_array($researchProYES)): $i = 0; $__LIST__ = $researchProYES;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-YES">
        ...
        <table>
            ...
            <tbody>
                <?php if(is_array($researchProNO)): $i = 0; $__LIST__ = $researchProNO;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-NO">
