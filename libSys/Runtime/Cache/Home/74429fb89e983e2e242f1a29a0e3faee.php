...
<script>
    ...
    layer.config({
       ...
       $("button.update").click(function(){
            var id = $(this).attr("id");
            var rep = $("td#"+id+"-rep").text();
            var title = $("td#"+id+"-title").text();
        ...
        layer.confirm('编辑项目后，已通过的项目将重新提交审核', {
            btn: ['确定','取消'], //按钮
               ...
               layer.open({
                   ...
                   shade: 0.8,
                   area: ['700px', '480px'],
                   content: "generalTeacherOtherNewsEdit.html" ,//iframe的url
                    success: function(layero,index)
                    {
                      var input_rep = layer.getChildFrame('#rep',index);
                      input_rep.val(rep);
                      var input_title = layer.getChildFrame('#title',index);
                      ...
                      input_id.click(function(){
                         ...
                         form1.ajaxSubmit({
                          url : "<?php echo U('Home/updateOtherNews');?>",
                          data: { data : id },
                          type : "post",
    ...
    $(document).ready(function(){
        $("button.add").click(function(){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '480px'],
                content: 'generalTeacherOtherNewsAdd.html', //iframe的url
                success: function(layero,index)
                {
                  var button = layer.getChildFrame('#btn',index);
                  button.click(function(){
                    var form = layer.getChildFrame('form#addothernews',index);
                   
                      form.ajaxSubmit({
                          url : "<?php echo U('Home/insertOtherNews');?>",
                          type : "post",
                          enctype : "multipart/form-data",
                          dataType:'json',
                          success: function(data){
      ...
      $(document).ready(function(){
        ...
        $("button.delete").click(function(){
            ...
            layer.confirm('可点击“编辑”以再次编辑并重新提交审核,删除后将不可恢复，确定删除该项目吗？',{
                    ...
                    //删除确定的ajax代码应该放在这里
                     $.post("<?php echo U('Home/deleteOtherNews');?>",{
                        data  : id
                      },
...
<!-- 主体部分 -->
    <div class="main">
        <div class="home">
            <h style="font-weight: bold;">新闻记录</h>
        </div>
        <div class="teacher">
            <h name="xi"><?php echo ($otherNews_WAIT); ?>项待审核 <?php echo ($otherNews_YES); ?>项已通过 
            <?php echo ($otherNews_NO); ?>项未通过</h>    
        </div>
        <div class="hr0">
            <hr>
        </div>
       ...
       <!-- 待审核 -->
        ...
        <table>
            ...
            <tbody>
                 <?php if(is_array($otherNewsWAIT)): $i = 0; $__LIST__ = $otherNewsWAIT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT">
        ...
        <table>
            ...
            <tbody>
                 <?php if(is_array($otherNewsYES)): $i = 0; $__LIST__ = $otherNewsYES;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-YES">
                   <td id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT-rep"><?php echo ($ta['rep']); ?></td>
                    <td id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT-title"><?php echo ($ta['title']); ?></td>
                    <td id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT-content"><?php echo ($ta['content']); ?></td>
        ...
        <table>
            ...
            <tbody>
                  ...
                  <?php if(is_array($otherNewsNO)): $i = 0; $__LIST__ = $otherNewsNO;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-NO">
                    <td id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT-rep"><?php echo ($ta['rep']); ?></td>
                    <td id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT-title"><?php echo ($ta['title']); ?></td>
                    <td id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT-content"><?php echo ($ta['content']); ?></td>
