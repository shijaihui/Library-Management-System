...
{
    $("#drp3").click();
    $("#m31").css("background-color","#363536");
        ...
        layer.confirm('编辑项目后，已通过的项目将重新提交审核', {
            btn: ['确定','取消'], //按钮
               ...
               layer.open({
                   ...
                   shade: 0.8,
                   area: ['700px', '480px'],
                   content: "generalTeacherResearchPapEdit.html" ,//iframe的url
                    success: function(layero,index)
                    {
                      ...
                      input_pub.val(pub);
                      var input_vnum = layer.getChildFrame('#vnum',index);
                      input_vnum.val(vnum);
                      ...
                      input_id.click(function(){
                         ...
                         form1.ajaxSubmit({
                          url : "<?php echo U('Home/updateResearchPap');?>",
                          data: { data : id },
                          type : "post",
    ...
    $(document).ready(function(){
        $("button.add").click(function(){
            layer.open({
                ...
                shade: 0.8,
                area: ['700px', '480px'],
                content: 'generalTeacherResearchPapAdd.html', //iframe的url
                success: function(layero,index)
                {
                  var button = layer.getChildFrame('#btn',index);
                  button.click(function(){
                    var form = layer.getChildFrame('form#addresearchpap',index);
                   
                      form.ajaxSubmit({
                          url : "<?php echo U('Home/insertResearchPap');?>",
                          type : "post",
                          enctype : "multipart/form-data",
                          dataType:'json',
                          success: function(data){
      ...
      $(document).ready(function(){
        ...
        $("button.delete").click(function(){
            ...
            layer.confirm('可点击“编辑”以再次编辑并重新提交审核,删除后将不可恢复，确定删除该项目吗？',{
                    ...
                    //删除确定的ajax代码应该放在这里
                     $.post("<?php echo U('Home/deleteResearchPap');?>",{
                        data  : id
                      },
...
<!-- 主体部分 -->
    <div class="main">
        <div class="home">
            <h style="font-weight: bold;">论文发表</h>
        </div>
        <div class="teacher">
            <h name="xi"><?php echo ($researchPap_WAIT); ?>项待审核 <?php echo ($researchPap_YES); ?>项已通过 
            <?php echo ($researchPap_NO); ?>项未通过</h>    
        </div>
        <div class="hr0">
            <hr>
        </div>
        ...
        <table>
            ...
            <tbody>
                 <?php if(is_array($researchPapWAIT)): $i = 0; $__LIST__ = $researchPapWAIT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-WAIT">
        ...
        <table>
            ...
            <tbody>
                 <?php if(is_array($researchPapYES)): $i = 0; $__LIST__ = $researchPapYES;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-YES">
        ...
        <table>
            ...
            <tbody>
                 <?php if(is_array($researchPapNO)): $i = 0; $__LIST__ = $researchPapNO;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-NO">
