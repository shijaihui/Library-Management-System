...
<div class="home">
        ...
        <div style="position: absolute;left: 200px;top: 60px;color: #AAAAAA;">
            <h><?php echo ($teachAch_WAIT); ?>项待审核</h></div>
        <div class="hr0">
            <hr>
        </div>          
          
            <form method="POST" action="<?php echo U('Admin/superAdminTeachAch');?>">
        ...
        <table>
            ...
            <tbody>
    <?php if(is_array($teachAch)): $i = 0; $__LIST__ = $teachAch;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ta): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-teach_ach">
        <td id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-name"><?php echo ($ta['name']); ?></td>
        <td id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-dep"><?php echo ($ta['dep']); ?></td>
        ...
        <?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-teach_ach-download" ><span class="glyphicon glyphicon-save" ></span></a></td>
        <td><button class="pass" id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-teach_ach">通过</button><button class="rj" id="<?php echo ($ta['id']); ?>-<?php echo ($ta['num']); ?>-<?php echo ($ta['years']); ?>-teach_ach">拒绝</button></td>
