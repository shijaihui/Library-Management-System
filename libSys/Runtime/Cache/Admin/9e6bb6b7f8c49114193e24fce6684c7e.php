...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/libSys/public/syspkg/css/changePassword.css">
	<title>index</title>
</head>
<body>
	...
	<div class="home" id="home">
		<div class="line"></div>
			...
			<div class="line">
				...
				<span><input type="password" id="new_password1" value=""></span>
			</div>
		<div class="line">
			<label>reinput password</label>
			<span><input type="password" id="new_password2" value=""  placeholder="please reinput"></span>
		</div>
